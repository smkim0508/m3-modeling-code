...
#function to determine num worker for each industry based on growth
#compare data from past years to present to form trendline
...
avg2020 = total_worker_2020/10
avg2021 = total_worker_2021/10

#relative percent proximity during work
mine = 0.54 #outdoor
manufacture = 0.70
trade = 0.58 
info = 0.68 #office
...
#weight metrics for each year of data
average_weight20 = ((num_mine20/avg2020)*mine + (num_manufacture20/avg2020)*manufacture + (num_trade20/avg2020)*trade + (num_info20/avg2020)*info + (num_finance20/avg2020)*finance + (num_business20/avg2020)*business + (num_eduhealth20/avg2020)*eduhealth + (num_leisure20/avg2020)*leisure + (num_other20/avg2020)*other + (num_government20/avg2020)*government)/10
average_weight21 = ((num_mine21/avg2021)*mine + (num_manufacture21/avg2021)*manufacture + (num_trade21/avg2021)*trade + (num_info21/avg2021)*info + (num_finance21/avg2021)*finance + (num_business21/avg2021)*business + (num_eduhealth21/avg2021)*eduhealth + (num_leisure21/avg2021)*leisure + (num_other21/avg2021)*other + (num_government21/avg2021)*government)/10

monthls = [0] * 9

percentvirtual = [0.54, 0.39, 0.35, 0.36, 0.34, 0.31, 0.26, 0.23, 0.25]

#vector set up for weighted percentage of virtual workers per industry per month
minew = [0] * 9
manufacturew = [0] * 9
tradew = [0] * 9
infow = [0] * 9
...
#vector set up for number of virtual workers per industry per month
minen = [0] * 9
manufacturen = [0] * 9
traden = [0] * 9
infon = [0] * 9
...
for month in range (0,9):
    ...
    if month < 4:
        #relative weight * ratio of workers in dustry to average workers total / average weight)
        minew[month] = (mine/average_weight20)*percentvirtual[month]
        manufacturew[month] = (manufacture/average_weight20)*percentvirtual[month]
        tradew[month] = (trade/average_weight20)*percentvirtual[month]
        financew[month] = (finance/average_weight20)*percentvirtual[month]
        businessw[month] = (business/average_weight20)*percentvirtual[month]
        eduhealthw[month] = (eduhealth/average_weight20)*percentvirtual[month]
        leisurew[month] = (leisure/average_weight20)*percentvirtual[month]
        otherw[month] = (other/average_weight20)*percentvirtual[month]
        governmentw[month] = (government/average_weight20)*percentvirtual[month]
        ...
        minew[month] = (mine/average_weight21)*percentvirtual[month]
        manufacturew[month] = (manufacture/average_weight21)*percentvirtual[month]
        tradew[month] = (trade/average_weight21)*percentvirtual[month]
        financew[month] = (finance/average_weight21)*percentvirtual[month]
        businessw[month] = (business/average_weight21)*percentvirtual[month]
        eduhealthw[month] = (eduhealth/average_weight21)*percentvirtual[month]
        leisurew[month] = (leisure/average_weight21)*percentvirtual[month]
        otherw[month] = (other/average_weight21)*percentvirtual[month]
        governmentw[month] = (government/average_weight21)*percentvirtual[month]
