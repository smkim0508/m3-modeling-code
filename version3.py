...
weight = [0, 0.005, 0.03, 1, 0.603333, 0.87, 0.515, 0.4825, 0.21, 0.97]
...
for month in range (0,9):
    ...
    minew[month] = weight[0]*percentvirtual[month]
    manufacturew[month] = weight[1]*percentvirtual[month]
    tradew[month] = weight[2]*percentvirtual[month]
    infow[month] = weight[3]*percentvirtual[month]
    financew[month] = weight[4]*percentvirtual[month]
    businessw[month] = weight[5]*percentvirtual[month]
    eduhealthw[month] = weight[6]*percentvirtual[month]
    leisurew[month] = weight[7]*percentvirtual[month]
    otherw[month] = weight[8]*percentvirtual[month]
    governmentw[month] = weight[9]*percentvirtual[month]
    ...
    if month < 4:
        ...
        infon[month] = infow[month] * num_trade20
        total_virtual[month] += infon[month]
        ...
        infon[month] = infow[month] * num_trade21
        total_virtual[month] += infon[month]
